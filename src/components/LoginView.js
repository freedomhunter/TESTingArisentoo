...
// import ArisenidJS from 'arisenid-js/packages/core'
import ArisenidJS from 'arisenid-js/packages/core';
...
class LoginView extends Component {
  ...
  loginClick = async () => {
    console.log('callesd')
    ArisenidJS.arisenid.connect('Text').then(connected => {
      console.log('connected vlaue',connected)
    })
    // if (!this.commonStore._initilizedArisenId) {
    //   this.commonStore.arisenidNeededAlert()
    // } else {
