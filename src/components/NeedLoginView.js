...
class NeedLoginView extends Component {
  ...
  render() {
    return (
      <section className="tv-404-animation">
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              <h2 className="tv-title-404-tm">Login first</h2>
              <p className="tv-text-404-tm">The page you are looking for need to login first</p>
              <button
                type="button"
