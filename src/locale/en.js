export default {
  ...
  Owner: 'Owner',
  'Account that performs action': 'Account that performs action',
  'Owner cannot be empty': 'Owner cannot be empty',
  'Owner public key': 'Owner public key',
  'Owner pubkey is required': 'Owner pubkey is required',
  'Owner pubkey cannot be empty': 'Owner pubkey cannot be empty',
  ...
  'No Tokens': 'No Tokens',
  'Quantity is requied': 'Quantity is requied',
  Search: 'Search',
